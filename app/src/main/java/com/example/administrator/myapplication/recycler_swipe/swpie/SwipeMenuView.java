...
public class SwipeMenuView extends LinearLayout {
    ...
    public void bindMenuItemClickListener(OnSwipeMenuItemClickListener
                                                  swipeMenuItemClickListener, SwipeSwitch
                                                  swipeSwitch) {
    ...
    private OnClickListener mMenuClickListener = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (mItemClickListener != null && mSwipeSwitch != null && mSwipeSwitch.isMenuOpen()) {
                mItemClickListener.onItemClick(mSwipeSwitch, mAdapterVIewHolder
                        .getAdapterPosition(), v.getId(), mDirection);
            }
        }
    };
}