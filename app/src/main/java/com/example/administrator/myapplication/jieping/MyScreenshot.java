...
public class MyScreenshot {
     ...
     */
    public MyScreenshot(Context context) {
        ...
        mBackgroundView = (ImageView) mScreenshotLayout.findViewById(R.id
                .global_screenshot_background);
...
//        mBgPadding = (float) r.getDimensionPixelSize(R.dimen.global_screenshot_bg_padding);
     ...
     */
    public void takeScreenshot(Activity activity, Runnable finisher, boolean
            statusBarVisible, boolean navBarVisible) {
        // Take the screenshot
        ...
        if (!statusBarVisible || !navBarVisible) {
            ...
            final PointF finalPos = new PointF(
                    -halfScreenWidth + (SCREENSHOT_DROP_OUT_MIN_SCALE + offsetPct) *
                            halfScreenWidth,
                    -halfScreenHeight + (SCREENSHOT_DROP_OUT_MIN_SCALE + offsetPct) *
                            halfScreenHeight);
    ...
    private void saveScreenshotInWorkerThread(Runnable runnable) {
        ...
        data.iconSize = mContext.getResources().getDimensionPixelSize(android.R.dimen
                .notification_large_icon_height);
        ;//mNotificationIconSize
        data.finisher = runnable;
        data.previewWidth = 1;//mPreviewWidth
        data.previewheight = 1;//mPreviewHeight
