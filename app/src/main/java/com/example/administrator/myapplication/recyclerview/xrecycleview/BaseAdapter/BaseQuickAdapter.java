...
package com.example.administrator.myapplication.recyclerview.xrecycleview.BaseAdapter;
...
import com.example.administrator.myapplication.recyclerview.xrecycleview.BaseAdapter.animation
        .AlphaInAnimation;
import com.example.administrator.myapplication.recyclerview.xrecycleview.BaseAdapter.animation
        .BaseAnimation;
import com.example.administrator.myapplication.recyclerview.xrecycleview.BaseAdapter.animation
...
public abstract class BaseQuickAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setHeaderViewCount(int headerViewCount) {
        this.headerViewCount = headerViewCount + 1;
    }
