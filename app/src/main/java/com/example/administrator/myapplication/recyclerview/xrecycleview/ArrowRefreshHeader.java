...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    private void initView() {
        ...
        mProgressBar.setAVLoadingIndicatorView(progressView);
    ...
    public void setProgressStyle(int style) {
        if (style == ProgressStyle.SysProgress) {
            mProgressBar.setView(new ProgressBar(getContext(), null, android.R.attr
                    .progressBarStyle));
        } else {
    ...
    public void setState(int state) {
        ...
        if (state == STATE_REFRESHING) {    // 显示进度
            ...
            mProgressBar.setLoadingEnable(View.VISIBLE);
            mProgressBar.setVisibility(View.VISIBLE);
        } else if (state == STATE_DONE) {
            mArrowImageView.setVisibility(View.INVISIBLE);
            mProgressBar.setLoadingEnable(View.INVISIBLE);
    ...
    private void smoothScrollTo(int destHeight) {
        if (destHeight == getVisibleHeight()) {
            return;
        }
