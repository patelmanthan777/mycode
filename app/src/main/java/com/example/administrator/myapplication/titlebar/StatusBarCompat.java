...
public class StatusBarCompat {
     ...
     *
     * @param hideStatusBarBackground hide status bar alpha Background when SDK > 21, true if
     *                                hide it
     */
    public static void translucentStatusBar(@NonNull Activity activity, boolean
