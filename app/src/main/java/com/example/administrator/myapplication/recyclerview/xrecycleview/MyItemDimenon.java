...
public class MyItemDimenon extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        // Next, move stuff
        if (movesPending) {
            final ArrayList<MoveInfo> moves = new
                    ArrayList<MoveInfo>();
        ...
        if (changesPending) {
            final ArrayList<ChangeInfo> changes =
                    new ArrayList<ChangeInfo>();
    ...
    public boolean animateMove(final ViewHolder holder, int fromX, int fromY,
        ...
        mPendingMoves.add(new MoveInfo(holder,
                fromX, fromY, toX, toY));
        return true;
    }
    ...
    public boolean animateChange(ViewHolder oldHolder, ViewHolder newHolder,
        ...
        mPendingChanges.add(new ChangeInfo
                (oldHolder, newHolder, fromX, fromY, toX, toY));
        return true;
    }
    ...
    private void endChangeAnimation(List<ChangeInfo
            > infoList, ViewHolder item) {
    ...
    public void endAnimation(ViewHolder item) {
        ...
        for (int i = mMovesList.size() - 1; i >= 0; i--) {
            ArrayList<MoveInfo> moves = mMovesList
                    .get(i);
