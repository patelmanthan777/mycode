...
public class SimpleViewSwitcher extends ViewGroup {
    ...
    public void setAVLoadingIndicatorView(AVLoadingIndicatorView view) {
        this.mAVLoadingIndicatorView = view;
        if (this.getChildCount() != 0) {
            this.removeViewAt(0);
        }
        this.addView(view, 0);
    ...
    public void setLoadingEnable(int visibily) {
        if (mAVLoadingIndicatorView == null) {
            return;
        }
        mAVLoadingIndicatorView.setVisibility(visibily);
    }
